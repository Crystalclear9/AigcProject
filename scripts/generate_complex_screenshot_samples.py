...
def own_app(output_dir: Path) -> None:
    ...
    draw_text(draw, (120, 420), "设置", 54, "#111827", True, 18)
    round_rect(draw, (80, 580, 1180, 1580), 50, "#FFFFFF")
    draw_text(draw, (150, 680), "AI 增强服务（可选）", 54, "#2563EB", True, 18)
    draw_text(draw, (150, 820), "服务地址，可留空", 42, "#6B7280", False, 24)
    draw_text(draw, (150, 960), "手机独立运行，不依赖开发主机", 42, "#111827", False, 25)
    draw_text(draw, (150, 1100), "提醒策略：1 天 / 3 小时 / 30 分钟", 42, "#111827", False, 24)
    bottom_tabs(draw)
